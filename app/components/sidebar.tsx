...
<svg className="hb" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 10" stroke="#FFF" stroke-width=".8" fill="rgba(0,0,0,0)" stroke-linecap="" style={{cursor: 'pointer'}} onClick={toggleSidebar}>
